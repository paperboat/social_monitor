...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { facebook: @statistic.facebook, fetch_date: @statistic.fetch_date, gplus: @statistic.gplus, linkedin: @statistic.linkedin, page_id: @statistic.page_id, twitter: @statistic.twitter }
    end
  ...
  test "should update statistic" do
    put :update, id: @statistic, statistic: { facebook: @statistic.facebook, fetch_date: @statistic.fetch_date, gplus: @statistic.gplus, linkedin: @statistic.linkedin, page_id: @statistic.page_id, twitter: @statistic.twitter }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
